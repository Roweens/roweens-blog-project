...
describe('articleCreateSlice test', () => {
    test('test set article', () => {
        const state: DeepPartial<ArticleCreateSchema> = {
            isLoading: false,
            blockCount: 0,
        ...
        expect(
            articleCreateReducer(
                state as ArticleCreateSchema,
                articleCreateActions.setNewArticle(article),
            ),
        ).toEqual({
            isLoading: false,
            blockCount: 0,
    ...
    test('test set block', () => {
        ...
        expect(
            articleCreateReducer(
                state as ArticleCreateSchema,
                articleCreateActions.setNewArticleBlock(article.blocks[0]),
            ),
        ).toEqual({
            isLoading: false,
            blockCount: 0,
