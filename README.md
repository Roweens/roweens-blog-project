...
Реализована как десктопная, так и мобильная версия сайта.
При загрузке страницы определяется тип устройства, отрисовывается разная версия приложения. Для работы с адаптивной версткой, брейкпоинтами реализованы соответствующие миксины.
